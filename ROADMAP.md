...
| **v0.3** | 🚧 in progress | global `npm i -g claude-trail` (this release), opt-in Bash matcher, daily log rotation, post-hoc redaction tool, per-session counters, `c` counter reset, `space` pause hotkey for `watch` |
